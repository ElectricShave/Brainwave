...
void loop() {
  ...
  Serial.println("Gamma Gap: Delta (2 Hz) - 10 sec. ");
  ...
  Serial.println("Phase V: DELTA (2 Hz) - 90 sec.");
  CurieTimerOne.pwmStart(13, 50.0, Delta);
   delay( 90000 );   // 90-sec  (elapsed:  430 sec.)

  Serial.println("Christ Gap: CHRIST (33 Hz) - 5 sec.");
  CurieTimerOne.pwmStart(13, 50.0, Christ);
   delay( 5000 );   // 5-sec  (elapsed: 435 sec.)

  Serial.println("Phase VI: THETA (4 Hz)- 90 sec.");
  CurieTimerOne.pwmStart(13, 50.0, Theta);
   delay( 90000 );  // 90-sec.  (elapsed: 525 sec.)

  Serial.println("LSD Gap: LSD (20 Hz) - 10 sec.");
  CurieTimerOne.pwmStart(13, 80.0, LSD);
   delay( 10000 );   // 10-sec  (elapsed: 535 sec.)

  Serial.println("Phase VII: ALPHA (9 Hz) - 60 sec.");
  CurieTimerOne.pwmStart(13, 50.0, Alpha);
